...
var MigrationExecutor = /** @class */ (function () {
    ...
    function MigrationExecutor(connection, queryRunner) {
        ...
        this.options = this.connection.driver.options;
        this.migrationsTableName = connection.options.migrationsTableName || "migrations";
        this.migrationsTable = this.connection.driver.buildTableName(this.migrationsTableName, this.options.schema, this.options.database);
    }
    // -------------------------------------------------------------------------
    // Public Methods
    // -------------------------------------------------------------------------
            ...
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, this.withQueryRunner(function (queryRunner) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!this.options.createSchema) return [3 /*break*/, 2];
                                    return [4 /*yield*/, this.createSchemaIfNotExist(queryRunner)];
                                case 1:
                                    _a.sent();
                                    _a.label = 2;
                                case 2: return [4 /*yield*/, this.createMigrationsTableIfNotExist(queryRunner)];
                                case 3:
                                    _a.sent();
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 10:
                        _a.sent();
                        if (!(this.transaction === "all" && transactionStartedByUs)) return [3 /*break*/, 12];
                        return [4 /*yield*/, queryRunner.commitTransaction()];
                    case 11:
                        _a.sent();
                        _a.label = 12;
                    ...
                    case 21: return [2 /*return*/, successMigrations];
                }
            });
        });
    };
    ...
    // Protected Methods
    // -------------------------------------------------------------------------
    MigrationExecutor.prototype.createSchemaIfNotExist = function (queryRunner) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.options.schema) return [3 /*break*/, 2];
                        return [4 /*yield*/, queryRunner.createSchema(this.options.schema, true)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
